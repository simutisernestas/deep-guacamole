...
def create_pose_data():
	info = {
		# '00': [0, 4540], '01': [0, 1100], '02': [0, 4660], '03': [0, 800], '04': [0, 270], '05': [0, 2760], '06': [0, 1100],
		# '07': [0, 1100], '08': [1100, 5170], '09': [0, 1590], '10': [0, 1200],
		'43': [000, 1332],
		'45': [000, 528],
		'46': [000, 816],
		'47': [000, 1734],
...
if __name__ == '__main__':
	...
	# train_video = ['45', '46']
	train_video = ['43']
	# train_video = ['43', '45', '46', '47', '49', '410', '4101', '4103']
	image_path_list = []

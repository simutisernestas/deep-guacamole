...
from fpv_dataset import FPVDataset
...
if __name__ == '__main__':
    ...
    fpv_data_dir = '../indoor_forward_9_snapdragon_with_gt/'
    fpv = FPVDataset(fpv_data_dir + 'left_images.txt', fpv_data_dir, fpv_data_dir + 'groundtruth.txt', new_size=new_size)

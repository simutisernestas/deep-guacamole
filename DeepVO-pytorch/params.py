...
class Parameters():
	def __init__(self):
		self.n_processors = 8
		# Path
		self.data_dir = '/home/michal/studia/m1sem/dl/project/repo/DeepVO-pytorch/KITTI/'
		self.image_dir = self.data_dir + '/images/'
		self.pose_dir = self.data_dir + '/pose_GT/'

		# self.train_video = ['00', '01', '02', '05', '08', '09']
		# self.valid_video = ['04', '06', '07', '10']
		self.train_video = ['43', '46', '47', '410', '4101', '4103']
		self.valid_video = ['45', '49', '4105']
		...
		# self.img_w = 608//2   # original size is about 1226
		# self.img_h = 184//2   # original size is about 370
		self.img_w = 640//3   # original size is about 640
		self.img_h = 480//3   # original size is about 480
		...
		self.img_means = (-0.0142497483543684, -0.0142497483543684, -0.0142497483543684)
		self.img_stds = (0.1915437671641082, 0.1915437671641082, 0.1915437671641082)
		...
		# self.load_model_path = 'models/pretrained/t000102050809_v04060710_im184x608_s5x7_b8_rnn1000_optAdagrad_lr0.0005.model.train'
		# self.load_optimizer_path = 'models/pretrained/t000102050809_v04060710_im184x608_s5x7_b8_rnn1000_optAdagrad_lr0.0005.optimizer.train'
